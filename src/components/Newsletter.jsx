    ...
    <div>
      <div className="flex items-center justify-center min-h-[27rem] md:min-h-[32rem] bg-white text-white px-4 ">
        ...
        <motion.div
          ...
          style={{ backgroundImage: `url(${bgImg})` }} className="bg-black text-white p-8 md:p-25  shadow-xl flex flex-col md:flex-row gap-8 max-w-7xl w-full">
          ...
          <form onSubmit={handleSubmit} className="flex-1 space-y-4">
           ...
           group relative inline-flex h-8 items-center justify-center overflow-hidden bg-neutral-950"><span>Subscribe</span><div className="ml-1 transition duration-300 group-hover:rotate-[360deg]"><svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-5 w-5"><path d="M8.14645 3.14645C8.34171 2.95118 8.65829 2.95118 8.85355 3.14645L12.8536 7.14645C13.0488 7.34171 13.0488 7.65829 12.8536 7.85355L8.85355 11.8536C8.65829 12.0488 8.34171 12.0488 8.14645 11.8536C7.95118 11.6583 7.95118 11.3417 8.14645 11.1464L11.2929 8H2.5C2.22386 8 2 7.77614 2 7.5C2 7.22386 2.22386 7 2.5 7H11.2929L8.14645 3.85355C7.95118 3.65829 7.95118 3.34171 8.14645 3.14645Z" fill="currentColor" fillRule="evenodd" clipRule="evenodd"></path></svg></div></button>
          </form>
        </motion.div>
      </div>
    </div>
