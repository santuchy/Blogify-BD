...
const UpdateBlog = () => {
    ...
    return (
      ...
      <div className="text-center text-white">
        <h1 className="text-4xl md:text-5xl font-bold mb-4">Update Blog</h1>
      </div>
      <div className="max-w-2xl mx-auto p-4 bg-black text-white rounded-2xl shadow-xl">
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="text-center">
            <button
              type="submit"
              className="focus:outline-none text-black bg-yellow-400 hover:bg-yellow-500 focus:ring-4 focus:ring-yellow-300 font-medium rounded-lg text-sm px-5 py-2.5"
            >
              Update
            </button>
          </div>
